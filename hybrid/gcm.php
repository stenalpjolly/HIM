<?php
   ...
   function sendMessageThroughGCM($registatoin_ids, $message) {
		...
		define("GOOGLE_API_KEY", "AIzaSyDjmms2EJTAu6VrnswdfDZLQTMkHsNugls"); 		
        $headers = array(
...
<?php
	...
	if(!empty($_GET["push"])) {	
		$gcmRegID  = "APA91bErLKpyv2i2ErAmrX41wXOhJ583fCUDwNxuvKW6AVO1oiCZILuPG5jKURgObxnkChltwpyiXA0goS00ru1XAXFKVdExuN5GiQF-C-PRUbvkC2lwJLpWYqN9gVvMq3OnjNq6KLfQaoyNJ-5IucHUbw4U10wtaA";
...
<html>
	...
	<body>
		...
		<form method="post" action="/hybrid/gcm.php/?push=true" onsubmit="return checkTextAreaLen()">					                                                      
